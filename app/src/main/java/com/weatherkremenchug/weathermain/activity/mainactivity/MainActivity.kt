package com.weatherkremenchug.weathermain.activity.mainactivity
...
import com.weatherkremenchug.weathermain.activity.settingsactivity.SettingsActivity
import com.weatherkremenchug.weathermain.activity.weatherontoday.WeatherOnTodayActivity
import com.weatherkremenchug.weathermain.adapter.WeatherMainAdapter
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private fun callWeather() {
        ...
        val callToServer = retrofit.create<CallToServer>(CallToServer::class.java)
